...
public class YCoordinateFirstPointComparator implements Comparator<QuadrilateralObservable> {
    ...
    public int compare(QuadrilateralObservable firstQuadrilateral, QuadrilateralObservable secondQuadrilateral) {
        ...
        return Double.compare(pointAFirstQuadrilateral.getY(), pointASecondQuadrilateral.getY());
    }
}
